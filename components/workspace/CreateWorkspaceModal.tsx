...
export const CreateWorkspaceModal: React.FC = () => {
  ...
  React.useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === 'Escape' && isCreateWorkspaceModalOpen) {
        handleClose();
      }
    };
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-border/50 bg-secondary/20 shrink-0">
        ...
        {/* Body Form */}
        <form onSubmit={handleCreate} className="flex-1 min-h-0 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-end gap-2.5 p-4 border-t border-border/40 bg-secondary/15 shrink-0">
            <button
              type="button"
              onClick={handleClose}
